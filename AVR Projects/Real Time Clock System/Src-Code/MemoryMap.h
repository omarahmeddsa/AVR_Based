...
#define TWCR_u8    *((volatile u8 *)0x56)
#define TWDR_u8    *((volatile u8 *)0x23)
#define TWAR_u8    *((volatile u8 *)0x22)
#define TWSR_u8    *((volatile u8 *)0x21)
#define TWBR_u8    *((volatile u8 *)0x20)

/****************************************************************
 * EEPROM
 ****************************************************************/

#define EEARH_u8    *((volatile u8 * )0x3F)
#define EEARL_u8    *((volatile u8 * )0x3E)
#define EEDR_u8     (*(volatile u8 * )0x3D)
#define EECR_u8     *((volatile u8 * )0x3C)
#define SPMCR_u8	*((volatile u8 * )0x57)
#define EEAR_16		*((volatile u16 * )0x3E)
